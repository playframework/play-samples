...
popd
pushd play-java-akka-cluster-example
zip -r -q ../play-java-akka-cluster-sbt-example.zip . -x "gradle/*" -x "scripts/*" -x "*gradle*"
zip -r -q ../play-java-akka-cluster-gradle-example.zip . -x "project/*" -x "scripts/*" -x "*.sbt"
popd
